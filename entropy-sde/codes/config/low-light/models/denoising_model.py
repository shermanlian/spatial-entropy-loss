...
from models.modules.loss import MatchingLoss,EntropyLoss
...
class DenoisingModel(BaseModel):
    def __init__(self, opt):
        ...
        if self.is_train:
            ...
            if loss_type == "l1":
                ...
                self.loss_fn = EntropyLoss(pixel_level=opt['train']['pixel_level'], name='hel')
    ...
    def test(self, sde=None, mode='sde', save_states=False):
        sde.set_mu(self.condition)
